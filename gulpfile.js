...
var config = {
	...
	src: {
		scripts: {
			...
			custom: './src/assets/toolkit/scripts/default.js'
		},
		styles: {
			fabricator: 'src/assets/fabricator/styles/fabricator.scss',
			toolkit: 'src/assets/toolkit/styles/default.scss'
		},
		images: 'src/assets/toolkit/images/**/*',
		fonts: 'src/assets/toolkit/font/**/*',
...
gulp.task('scripts', function (done) {
	...
	// default.js
	gulp.src(config.src.scripts.custom)
...
gulp.task('fonts', function () {
	return gulp.src(config.src.fonts)
		.pipe(gulp.dest(config.dest + '/assets/toolkit/font'));
});
